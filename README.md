...
*Outputs a new file (`target_eq_volume_matched.txt`) with a mathematically corrected Preamp value. The resulting file can be loaded directly into SoundSource or Equalizer APO (including the Peace GUI) and is fully compatible with profiles generated by AutoEQ or [AcoustiQ](https://github.com/MrChillStorm/AcoustiQ).*

## 🚀 Quick Start

1. Download **`headphone_target_0.3661543.csv`**.
2. Load the file as a custom target in [AcoustiQ](https://github.com/MrChillStorm/AcoustiQ) or AutoEQ, alongside your headphone's raw measurement to generate your EQ filters.
